-- Ensure vendor_self_attestations exists in public schema so pgAdmin and other clients can see it.
-- Run this if the table is not visible or shows no data in pgAdmin.
