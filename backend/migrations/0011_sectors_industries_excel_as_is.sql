-- Replace sectors and industries with Excel "Industry_sectors" sheet structure as-is.
-- No UUIDs: use integer IDs from Excel (industry_id, industry_sector_id).
...
CREATE TABLE "industries" (
  ...
  "industry_id" integer NOT NULL REFERENCES "sectors"("industry_id") ON DELETE CASCADE,
  "sector_name" varchar(200) NOT NULL
);

-- Excel data: Industry table (industry_id, industry_name)
INSERT INTO "sectors" ("industry_id", "industry_name") VALUES
  (1, 'public'),
  (2, 'private'),
  (3, 'non-profit');

-- Excel data: Industry Sectors table (industry_sector_id, industry_id, sector_name) - names trimmed
INSERT INTO "industries" ("industry_sector_id", "industry_id", "sector_name") VALUES
