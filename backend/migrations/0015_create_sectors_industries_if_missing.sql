-- Create sectors and industries tables if missing (Excel "Industry_sectors" structure).
-- Safe to run: CREATE TABLE IF NOT EXISTS; INSERT uses ON CONFLICT DO NOTHING.
...
-- Seed sectors (Excel: Industry block)
...
-- Seed industries (Excel: Industry Sectors block)
